...
static bool IsMin(const long double& p) {
	bool ret;
	int round_away;
...
static ostream& OutSingular(ostream& out, int base, const long double& value) {
...
static ostream& OutLittleNumber(ostream& out, int base, const long double& value) {
	const char* write_after_sign = NULL;  // unused for now
	int digits = 0;					   // forced 0 digits after separator
...
static ostream& OutNumber(ostream& out, int base, const long double& value) {
